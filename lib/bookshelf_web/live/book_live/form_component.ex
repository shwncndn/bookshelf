defmodule BookshelfWeb.BookLive.FormComponent do
  ...
  def update(%{book: book} = assigns, socket) do
    changeset = Formats.change_book(book)
  ...
  def handle_event("validate", %{"book" => book_params}, socket) do
    changeset =
      socket.assigns.book
      |> Formats.change_book(book_params)
  ...
  defp save_book(socket, :edit, book_params) do
    case Formats.update_book(socket.assigns.book, book_params) do
      {:ok, book} ->
  ...
  defp save_book(socket, :new, book_params) do
    case Formats.create_book(book_params) do
      {:ok, book} ->
        notify_parent({:saved, book})
